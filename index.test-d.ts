...
expectType<Promise<string>>(usingSafe({[Symbol.dispose]() {/* noop */}}, () => 'hello'));

expectType<Promise<number>>(usingSafe({close() {/* noop */}}, async () => 42));

// Sync version returns direct value
expectType<string>(usingSafeSync({[Symbol.dispose]() {/* noop */}}, () => 'hello'));

expectType<number>(usingSafeSync({destroy() {/* noop */}}, () => 42));
